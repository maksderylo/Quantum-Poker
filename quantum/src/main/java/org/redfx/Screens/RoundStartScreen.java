...
/**A class for the screen showing an update before card turns. 
 * For example before the preflop round or before the river round. */
public class RoundStartScreen extends JPanel {
    ...
    /**Constructing the screen by displaying each player by their name, their role this round 
     * (big blind, small blind, folded, ect.), what round it is (preflop, flop, ect.),
     * and the current pool.
     * 
     * @param round is the round from which the constructor gets the information,
     *      such as the player names.
     * @param phase is a string representing which phase of the round the players are in.
     *      (preflop, flop, ect.)  */
